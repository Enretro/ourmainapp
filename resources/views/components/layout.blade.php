...
<html lang="en">
  ...
  <body>
    ...
    <footer class="border-top text-center small text-muted py-3">
      <p class="m-0">Copyless &copy; {{date('Y')}} <a href="/" class="text-muted">enApp</a>. All lefts reserved.</p>
    </footer>
    ...
    <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.1.3/js/bootstrap.min.js" integrity="sha384-ChfqqxuZUCnJSK3+MXmPNIyE6ZbWh2IMqE241rYiqJxyMiZ6OW/@" crossorigin="anonymous"></script>
    <script>
